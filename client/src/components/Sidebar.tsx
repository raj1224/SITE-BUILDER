...
import type { Version } from '@/assets';
...
const Sidebar = ({isMenuOpen,project,setProject,isGenerating,setIsGenerating}:SidebarProps) => {
    ...
    const handleRollback=async(versionId:string)=>{
        try {
            const confirm = window.confirm('Are you sure you want ot rollback to this version?')
            if(!confirm) return;
                ...
                {isGenerating && (
                    <div className='flex items-start gap-3 justify-start'>
                        ...
                        <div className='flex gap-1.5 h-full items-end '>
                            ...
                            <span className='size-2 rounded-full animate-bounce bg-gray-600' style={{animationDelay:'02s'}}/>
                            <span className='size-2 rounded-full animate-bounce bg-gray-600' style={{animationDelay:'04s'}}/>
                        </div>
                    </div>
                )}
                <div ref={messageRef}/>
