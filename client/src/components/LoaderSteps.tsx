...
const steps=[
    ...
    {icon:CircleIcon,label:"Finalinzing your website..."},
]
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white'>
        ...
        <div className='relative z-10 w-32 h-32 flex items-center justify-center'>
            <div className='absol
             inset-0 rounded-full border border-indigo-400 animate-ping opacity-30'/>
        ...
        <p className='text-xs text-gray-400 mt-2 trasition-opacity duration-700 opacity-100'>This may take around 2-3 minutes...</p>
    </div>
  )
}
