...
export const createUserProject = async (req: Request,res:Response) => {
    ...
    try {
        ...
        // Enhance user prompt
        const proptEnhanceResponse=await openai.chat.completions.create({
...
`
        ...
        const enhancedPrompt=proptEnhanceResponse.choices[0].message.content;
...
`
        ...
        await prisma.conversation.create({
            data:{
                role:'assistant',
                content:"I've generated your website! You can view and edit it now.",
                projectId:project.id
            }
        })
